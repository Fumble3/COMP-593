...
def main():
    ...
    ctypes.windll.shell32.SetCurrentProcessExplicitAppUserMode1ID(app_id)
    root.iconbitmap(os.path.join(script_dir, 'favicon.ico'))
    ...
    def handle_btn_set_desktop():
        ...
        btn_set_desktop = ttk.Button(frm, text='Set a Desktop Image', command=handle_btn_set_desktop)
        btn_set_desktop.state(['disabled'])
